...
// Převede čas ve formátu HH:MM na minuty od půlnoci
export function timeToMinutes(timeStr) {
  const [h, m] = timeStr.split(':').map(Number)
  return h * 60 + m
}

// Zaokrouhlí minuty na nejbližší 30minutový slot
export function snapToSlot(minutes) {
  return Math.round(minutes / SLOT_MINUTES) * SLOT_MINUTES
}

// Vrátí pole 7 objektů {dayOfWeek, date, label} pro týden s daným offsetem od aktuálního
...
// Vrátí textový rozsah týdne, např. "5. 5. – 11. 5. 2025"
...
// Vrátí pole minutových hodnot pro každý 30minutový slot (08:00–22:00)
